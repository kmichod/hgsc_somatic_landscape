...
java -jar /uufs/chpc.utah.edu/common/PE/hci-bioinformatics1/TNRunner/BioApps/USeq/Apps/AnnotatedVcfParser -v /uufs/chpc.utah.edu/common/HIPAA/u1325930/aaces/hgsc_landscape/data -s /uufs/chpc.utah.edu/common/HIPAA/u1325930/aaces/hgsc_landscape/data/germline_highconfidence -d 30 -m 0.15 -w 4 -z 3

## after vcf parser remove any VCFs failing these parameters as well as the hyper-mutated sample 

cd /uufs/chpc.utah.edu/common/HIPAA/u1325930/aaces/hgsc_landscape/data/germline_highconfidence
