...
directory <- "/Users/kayleighlawson-michod/OneDrive - University of Utah/Doherty/AACES_Tissue_Grant/1.Writing/GitHub"
...
tissue_black_corrected_sbs_96 <- read.delim(file.path(directory, "cosmic/SigProfilerAssignment/SigProfilerAssignment/schildkraut_black_ffpecorrected_n191/Assignment_Solution/Activities/Assignment_Solution_Activities.txt"))
...
sbs_tissue_black <- sbs96_counts_to_tmb(sbs_tissue_black_long)
sbs_tcga_white_nature_long <- sbs96_longer(tcga_white_nature_sbs_96)
sbs_tcga_white_nature <- sbs96_counts_to_tmb(sbs_tcga_white_nature_long)
